...
async def khalid(client: Client, message: Message):
    await message.reply_photo(
        photo=f"https://telegra.ph/file/81546aa02d1468cac4055.jpg",
        caption=f"""ᴡᴇʟᴄᴏᴍᴇ ᴀɴᴅ ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ ʏᴏᴜ sᴏᴜʀᴄᴇ ʟɪɴᴅᴀ""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                InlineKeyboardButton("ᴅᴇᴠᴇʟᴏᴘᴇʀ", url=f"https://t.me/FH_KN"),
                ],[
                InlineKeyboardButton(
                        "sᴏᴜʀᴄᴇ", url=f"https://t.me/Just_Ghosst"),
                ]
            ]
        ),
    )
...
async def khalid(client: Client, message: Message):
    await message.reply_photo(
        photo=f"https://telegra.ph/file/81546aa02d1468cac4055.jpg",
        caption=f"""[ᴡᴇʟᴄᴏᴍᴇ ᴀɴᴅ ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ ʏᴏᴜ sᴏᴜʀᴄᴇ ʟɪɴᴅᴀ](https://t.me/FH_KP)""",
        reply_markup=InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton(
                        "ᴅᴇᴠᴇʟᴏᴘᴇʀ", url=f"https://t.me/FH_KN"),
            ],[
