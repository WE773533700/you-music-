            ...
            [
                [
                    InlineKeyboardButton(
                        "« قنـاة البـوت »", url=f"https://t.me/FH_KP"),
                ],
            ]
        ),
    )
...
async def khalid(client: Client, message: Message):
    await message.reply_photo(
        ...
        caption=f"""مرحـباً بك """,
        reply_markup=InlineKeyboardMarkup(
            [
                [
                InlineKeyboardButton("ب̾يٰ͊ڪ͢ــ̲‌‏ـ۫ـٰ۫اۢسُ͂ــ٘و𓅗™⍣ًُᵛ͢ᵎᵖ³", url=f"https://t.me/FH_KN"),
                ],[
                InlineKeyboardButton(
                        "« قنـاة البـوت »", url=f"https://t.me/FH_KP"),
                ]
...
async def khalid(client: Client, message: Message):
    await message.reply_photo(
        photo=f"https://telegra.ph/file/901c5d4a13bfe67584876.jpg",
        caption=f"""[˝ انضـم القنـاة البـوت ˝](https://t.me/FH_KP)""",
        reply_markup=InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton(
                        "ب̾يٰ͊ڪ͢ــ̲‌‏ـ۫ـٰ۫اۢسُ͂ــ٘و𓅗™⍣ًُᵛ͢ᵎᵖ³", url=f"https://t.me/FH_KN"),
            ],[
